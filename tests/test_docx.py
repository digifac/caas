...
class TestSanitizeUrl:
    ...
    def test_empty_string_returns_as_is(self):
        from app.converters.docx import _sanitize_url

        assert _sanitize_url("") == ""

    def test_safe_http_url_preserved(self):
        from app.converters.docx import _sanitize_url

        assert _sanitize_url("https://example.com/page") == "https://example.com/page"

    def test_safe_mailto_preserved(self):
        from app.converters.docx import _sanitize_url
    ...
    def test_data_scheme_blocked(self):
        ...
        assert _sanitize_url("data:text/html,<h1>XSS</h1>") == "#"
    ...
    def test_data_scheme_with_whitespace(self):
        from app.converters.docx import _sanitize_url
...
class TestEscapeMdText:
    ...
    def test_plain_text_unchanged(self):
        from app.converters.docx import _escape_md_text

        assert _escape_md_text("Hello World") == "Hello World"

    def test_html_lt_gt_escaped(self):
        from app.converters.docx import _escape_md_text

        assert (
            _escape_md_text("<script>alert(1)</script>")
    ...
    def test_html_ampersand_escaped(self):
        ...
        assert _escape_md_text("Tom & Jerry") == "Tom &amp; Jerry"
...
class TestConvertDocxToMd:
    ...
    def test_conversion_with_mammoth_warnings(self, sample_docx_bytes, caplog):
        """Warnings from mammoth should be logged."""
        mock_msg = MagicMock()
        mock_msg.__str__ = lambda self: "Unknown element: w:sdt"
        ...
        with patch("app.converters.docx.mammoth") as mock_mammoth:
            ...
            with caplog.at_level(logging.WARNING):
                ...
                convert_docx_to_md(sample_docx_bytes)

        assert "DOCX Warning:" in caplog.text

    def test_dangerous_link_in_markdown_sanitized(self, sample_docx_bytes):
    ...
    def test_dangerous_image_url_sanitized(self, sample_docx_bytes):
    ...
    def test_file_url_in_image_sanitized(self, sample_docx_bytes):
    ...
    def test_multiple_links_and_images_sanitized(self, sample_docx_bytes):
    ...
    def test_empty_markdown_output(self, sample_docx_bytes):
    ...
    def test_whitespace_only_markdown(self, sample_docx_bytes):
